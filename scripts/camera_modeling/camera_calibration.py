...
def main():
    ...
    flight_dir = 'Y:/NMML_Polar_Imagery/KAMERA_Calibration/2024_IceSeals/camera_model_development/fl09'

    # You should have a colmap directory where all of the Colmap-generated files
    # reside.
    colmap_dir = 'Y:/NMML_Polar_Imagery/KAMERA_Calibration/2024_IceSeals/camera_model_development/fl09/colmap'
