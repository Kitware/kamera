C:\software\COLMAP-3.6-windows-cuda\COLMAP.bat mapper^
        ...
        --output_path Y:\NMML_Polar_Imagery\KAMERA_Calibration\2024_IceSeals\camera_model_development\fl09\colmap_ir\sparse^
        --Mapper.min_num_matches=15^
        --Mapper.ignore_watermarks=0^
        --Mapper.multiple_models=1^
        --Mapper.max_num_models=20^
